...
#Answer yes output
       if  message.content.startswith('yes') or message.content.startswith('Yes'):
            await message.channel.send('How you can get started:'
...
#Answer with no
            ...
            await message.channel.send('Enter "$help" to find commands you can use in this server for analyzing stock')
#Invalid input
       elif len(message.content) > 1 and not message.content.startswith('$help') and not message.content.startswith('$active') and \
               not message.content.startswith('$buy') and not message.content.startswith('$graph'):
